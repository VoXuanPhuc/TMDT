  ...
  <aside class="app-sidebar">
      <div class="app-sidebar__user">
          <img class="app-sidebar__user-avatar" src="https://static2.yan.vn/YanNews/2167221/202102/facebook-cap-nhat-avatar-doi-voi-tai-khoan-khong-su-dung-anh-dai-dien-e4abd14d.jpg" width="50px" alt="User Image">!-
          <div>
      ...
      <ul class="app-menu">
          ...
          <li><a class="app-menu__item active7" href="khuyenmai"><i class='app-menu__icon bx bxl-blogger'></i><span class="app-menu__label">Quản lý Blogs</span></a> </li>
