        ...
        <div class="tile-body">
          <form action="?mod=sanpham&act=store" method="POST" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-md-2">
              ...
              <input class="form-control" name="LoaiMau1" type="text">
            </div>
            <div class="form-group col-md-2">
              <label class="control-label">Màu 2</label>
              <input class="form-control" name="LoaiMau2" type="text">
            </div>
            <div class="form-group col-md-2">
              <label class="control-label">Màu 3</label>
              <input class="form-control" name="LoaiMau3" type="text">
            </div>
            <div class="form-group col-md-2">
              <label class="control-label">Màu 4</label>
              <input class="form-control" name="LoaiMau4" type="text">
            </div>
            <div class="form-group col-md-2">
              <label class="control-label">Màu 5</label>
              <input class="form-control" name="LoaiMau5" type="text">
            </div>
            <div class="form-group col-md-2">
