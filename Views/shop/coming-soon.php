    ...
    <div class="soon">
                ...
                <div class="col-md-9 col-lg-8">
                    ...
                    <div class="soon-content text-center">
                        ...
                        <div class="soon-content-wrapper">
                            ...
                            <img src="public/assets/images/icon-logo.webp" alt="Logo" width="5%" height="20px" class="soon-logo mx-auto">
        ...
        <?php if ($ComingSoon_data != NULL) {
            foreach ($ComingSoon_data as $item) { ?>
                <div class="soon-bg bg-image" style="background-image: url(public/assets/images/products/<?= $item['HinhAnh2'] ?>)"></div>
        <?php }
        } ?>
